...
,trigged_status_()
{
    ...
    joy_sub_ =  nh_.subscribe<sensor_msgs::Joy>("joy", 10, &cmd_vel_rectifier::joy_sub, this);
    cmd_vel_sub_ =  nh_.subscribe<geometry_msgs::Twist>("cmd_vel", 10, &cmd_vel_rectifier::cmd_vel_sub, this);
    battery_sub_ = nh_.subscribe("/battery", 1, &cmd_vel_rectifier::BatteryCallBack, this);
...
void cmd_vel_rectifier::SoundPlayerPub( int sound )
{
...
void cmd_vel_rectifier::CmdVelRectifiedPubStop()
{
    robot_in_move_ = false;
...
void cmd_vel_rectifier::CmdVelRectifiedPub(geometry_msgs::Twist msg_twist)
{
...
void cmd_vel_rectifier::BatteryCallBack(const sensor_msgs::BatteryStatePtr &battery_msg)
{
...
void cmd_vel_rectifier::LightControl( const sensor_msgs::Joy &joy )
{
    sensor_msgs::JoyFeedback joy_feedback;
...
void cmd_vel_rectifier::SoundPlayerControl()
{
